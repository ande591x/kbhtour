    ...
    a.fn.extend({
        beforeAfter: function (b) {
            ...
            return this.each(function () {
                ...
                a(k).prepend('<div id="dragwrapper' + c + '"><div id="drag' + c + '"><img width="8" height="56" alt="handle" src="' + l.imagePath + 'img/handle.gif" id="handle' + c + '" /></div></div>');
                a("#dragwrapper" + c).css({
                    opacity: 0.25,
                    position: "absolute",
                    padding: "0",
                ...
                a(k).append('<img src="' + l.imagePath + 'img/lt-small.png" width="7" height="15" id="lt-arrow' + c + '"><img src="' + l.imagePath + 'img/rt-small.png" width="7" height="15" id="rt-arrow' + c + '">');
                if (l.showFullLinks) {
                ...
                if (l.enableKeyboard) {
                    a(document).keydown(function (m) {
                        if (m.keyCode == 39) {
                            if ((parseInt(a("#dragwrapper" + c).css("left")) + parseInt(a("#dragwrapper" + c).width()) + l.keypressAmount) <= f) {
                                a("#dragwrapper" + c).css("left", parseInt(a("#dragwrapper" + c).css("left")) + l.keypressAmount + "px");
                                a("div:eq(2)", k).width(parseInt(a("div:eq(2)", k).width()) + l.keypressAmount + "px")
                            } else {
                                a("#dragwrapper" + c).css("left", f - parseInt(a("#dragwrapper" + c).width()) + "px");
                                a("div:eq(2)", k).width(f - parseInt(a("#dragwrapper" + c).width()) / 2 + "px")
                            }
                        }
                        if (m.keyCode == 37) {
                            if ((parseInt(a("#dragwrapper" + c).css("left")) - l.keypressAmount) >= 0) {
                                a("#dragwrapper" + c).css("left", parseInt(a("#dragwrapper" + c).css("left")) - l.keypressAmount + "px");
                                a("div:eq(2)", k).width(parseInt(a("div:eq(2)", k).width()) - l.keypressAmount + "px")
                            } else {
                                a("#dragwrapper" + c).css("left", "0px");
                                a("div:eq(2)", k).width(a("#dragwrapper" + c).width() / 2)
                            }
                        }
                    })
                }
